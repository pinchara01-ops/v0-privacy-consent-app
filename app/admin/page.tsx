...
import { Shield, Database, Activity, Users, CheckCircle, XCircle, Clock, Globe, RefreshCw } from 'lucide-react'
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-4">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-sm text-gray-600">Live • {lastUpdate.toLocaleTimeString()}</span>
                            </div>
                            <button
                                onClick={fetchData}
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <div className="flex items-center gap-2">
                                                    <p className="text-xs text-gray-500">
                                                        Updated: {new Date(consent.updated_at).toLocaleTimeString()}
                                                    </p>
                                                    {new Date().getTime() - new Date(consent.updated_at).getTime() < 5000 && (
                                                        <span className="px-2 py-0.5 bg-yellow-100 text-yellow-800 text-[10px] font-bold rounded-full animate-pulse">
                                                            NEW
                                                        </span>
                                                    )}
                                                </div>
